...
<main class="container-fluid p-0">
    ...
    <div class="d-flex flex-column justify-content-center align-items-center p-5" data-aos="fade-up">
        <h1 class="pb-5"> Loja sem variedades. </h1>
    ...
    <div id="slide-products" class="carousel slide bg-primary" data-bs-ride="carousel">
                ...
                <div class="container-sm"> 
                    <div class="row p-5">
                        <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up">
                            ...
                            <h5 class="py-2">Mouse preto simples e extremamente caro.</h5>
                            <h6><strong>Por: <span class="h4">$4.56</span></strong></h6>
                            <p>O mouse mais caro do mundo, perfeito para você.</p>
                        </div>
        ...
        <!-- Button Prev -->
        <button class="d-none d-md-block carousel-control-prev" type="button" data-bs-target="#slide-products" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>

        <!-- Button Next -->
        <button class="d-none d-md-block carousel-control-next" type="button" data-bs-target="#slide-products" data-bs-slide="next">
            <span class="carousel-control-next-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Next</span>
        </button>
    </div> <!-- End Carousel -->
